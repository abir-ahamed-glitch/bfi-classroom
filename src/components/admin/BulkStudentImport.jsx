                        ...
                        {editingId === item.id ? (
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                            <div style={{ fontWeight: '600', color: 'var(--text-primary)' }}>
                              {item.title || (item.batch_number === 'Registered Batch' || item.batch_number === 'Mixed' ? item.batch_number : `${getOrdinalSuffix(item.batch_number)} Batch`)}
                            </div>
                                ...
                                <div style={{
                                  ...
                                  <button
                                    onClick={(e) => {
                                      ...
                                      setEditTitle(item.title || (item.batch_number === 'Registered Batch' || item.batch_number === 'Mixed' ? item.batch_number : `${getOrdinalSuffix(item.batch_number)} Batch`));
                                      setMenuOpenId(null);
                                    }}
                                    style={{
                                      background: 'none',
